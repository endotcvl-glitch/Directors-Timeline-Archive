...
const yearSummaries = {
    2000: 'リドリー・スコット監督の『グラディエーター』が世界的な大ヒットを記録。クリストファー・ノーラン監督『メメント』が公開。時間というテーマがここから始まりました。',
    2001: '米同時多発テロ（9.11）で海外スターの来日などに影響。『ハリー・ポッター』『ロード・オブ・ザ・リング』など長編ファンタジー大作が公開されました。',
    2002: 'ジョージ・ルーカス監督の『スター・ウォーズ エピソード2/クローンの攻撃』が、全編デジタル撮影によるメジャー大作として公開されました。',
    2003: '『マトリックス』の完結に至る続編２作『マトリックス リローデッド』『マトリックス レザレクションズ』が連続公開され話題となりました。',
    2004: '前年公開のロード・オブ・ザ・リング／王の帰還』が第76回アカデミー賞を席巻しました。',
    2005: 'スティーヴン・スピルバーグ監督の２作品公開。クリストファー・ノーラン監督：『バットマン ビギンズ』が公開され新しいヒーロー映画の形を提示しました。',
    ...
    2010: '前年公開の『アバター』が2010年にかけて記録的な大ヒットを記録し、映画館のデジタル化が世界規模で急加速しました。',
    2011: '『ハリー・ポッター』シリーズ完結。『猿の惑星』のリブート作『猿の惑星: 創世記』が成功し現在に至るまで続編が作り続けられている。',
    2012: '『アベンジャーズ』公開。サム・メンデス監督『007 スカイフォール』がシリーズ50周年記念作品として全世界で大ヒットを記録しました。',
    2013: 'マーティン・スコセッシ監督とレオナルド・ディカプリオと5度目のタッグ『ウルフ・オブ・ウォールストリート』が公開。熱量の高さと狂気が話題に。',
    2014: 'クリストファー・ノーランの壮大なSF巨編『インターステラー』が公開されたほか、『アナと雪の女王』が大ヒット。',
    2015: 'ジョージ・ミラー監督『マッドマックス 怒りのデス・ロード』公開。翌年の第88回アカデミー賞で6冠を達成します。',
    2016: 'アレックス・ガーランド初監督作品となるSFスリラー『エクス・マキナ』が高く評価されました。',
    ...
    2024: 'アレックス・ガーランド監督『シビル・ウォー アメリカ最後の日』公開。現代アメリカの分断をリアルに描き話題に。日本では年間映画興行収入ランキングから初めて実写洋画がランキングされませんでした。',
    2025: 'マーベルの大作が伸び悩み再構成が進む中、ジェームズ・ガン監督の新生『スーパーマン』が大ヒットを記録。',
