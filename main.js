...
const directorsInfo = {
    ...
    'emmerich': { fullNameEn: 'ROLAND EMMERICH', nameJa: 'ローランド・エメリッヒ', surname: 'EMMERICH' },
...
const filmsData = [
    ...
    { year: 1977, type: 'lucas', title: "スター・ウォーズ EP4/新たなる希望", context: "世界的社会現象を巻き起こした、SF映画の金字塔。" },
    { year: 1999, type: 'lucas', title: "スター・ウォーズ EP1/ファントム・メナス", context: "新三部作の第1章。アナキン・スカイウォーカーの少年時代を描く。" },
    { year: 2002, type: 'lucas', title: "スター・ウォーズ EP2/クローンの攻撃", context: "新三部作の第2章。クローン戦争の勃発とジェダイの苦闘を描く。" },
    { year: 2005, type: 'lucas', title: "スター・ウォーズ EP3/シスの復讐", context: "新三部作の完結編。アナキンがダース・ベイダーへと変貌する悲劇を描く。" },
    ...
    // Roland Emmerich
    { year: 1984, type: 'emmerich', title: "スペースノア", context: "宇宙ステーションを舞台に、地球規模の気象操作と破局のイメージを描いた長編デビュー作。" },
    { year: 1985, type: 'emmerich', title: "Joey", context: "少年と超自然的な力をめぐる物語を、ファンタジーとホラーの感覚で描いた初期作。" },
    { year: 1987, type: 'emmerich', title: "Hollywood-Monster", context: "怪物映画への愛着とコメディを混ぜた、ドイツ時代のポップなジャンル映画。" },
    { year: 1990, type: 'emmerich', title: "ムーン44", context: "資源をめぐる宇宙企業の争いを、閉鎖空間のSFアクションとして描いた作品。" },
    { year: 1992, type: 'emmerich', title: "ユニバーサル・ソルジャー", context: "蘇生された兵士たちの戦いを通じて、ハリウッド大作へ踏み出したSFアクション。" },
    { year: 1994, type: 'emmerich', title: "スターゲイト", context: "古代文明と宇宙をつなぐゲートを題材に、神話的SFアドベンチャーを広げた代表作。" },
    { year: 1996, type: 'emmerich', title: "インデペンデンス・デイ", context: "地球規模の侵略と反撃を、都市破壊のスペクタクルで描いた90年代ブロックバスター。" },
    { year: 1998, type: 'emmerich', title: "GODZILLA", context: "日本の怪獣像をハリウッド大作として再構成し、巨大生物パニックへ寄せた作品。" },
    { year: 2000, type: 'emmerich', title: "パトリオット", context: "アメリカ独立戦争を背景に、家族と復讐の物語を壮大な歴史アクションとして描いた作品。" },
    { year: 2004, type: 'emmerich', title: "デイ・アフター・トゥモロー", context: "気候変動による氷河期的危機を、現代的なディザスター映画として視覚化した大作。" },
    { year: 2008, type: 'emmerich', title: "紀元前1万年", context: "先史時代の冒険譚を、巨大動物や古代文明のイメージとともに描いたスペクタクル。" },
    { year: 2009, type: 'emmerich', title: "2012", context: "世界崩壊のイメージを極限まで押し広げ、破壊の連鎖を大作映画の快感へ変えた作品。" },
    { year: 2011, type: 'emmerich', title: "もうひとりのシェイクスピア", context: "シェイクスピア別人説を題材に、政治陰謀と文学史のミステリーを描いた異色作。" },
    { year: 2013, type: 'emmerich', title: "ホワイトハウス・ダウン", context: "ホワイトハウス襲撃を舞台に、危機管理とバディアクションを軽快に組み合わせた作品。" },
    { year: 2015, type: 'emmerich', title: "ストーンウォール", context: "1969年のストーンウォール蜂起を題材に、社会運動の記憶へ向き合ったドラマ。" },
    { year: 2016, type: 'emmerich', title: "インデペンデンス・デイ:リサージェンス", context: "前作の侵略後の世界を広げ、再来する脅威をさらに巨大なスケールで描いた続編。" },
    { year: 2019, type: 'emmerich', title: "ミッドウェイ", context: "太平洋戦争の転機となる海戦を、群像劇と航空戦のスペクタクルで描いた戦争映画。" },
    { year: 2022, type: 'emmerich', title: "ムーンフォール", context: "月が地球へ落下するという極端な設定で、宇宙規模のディザスターを描いたSF大作。" },
...
const episodesData = {
    1954: "『ゴジラ』公開 ",
    1957: "スプートニク1号打ち上げ<br>宇宙時代の幕開け",
    1963: "ケネディ大統領暗殺事件",
    1969: "アポロ11号月面着陸",
    1973: "オイルショック",
    1975: "『ジョーズ』公開<br>ブロックバスター映画の誕生",
    1977: "ILM設立",
    1979: "ウォークマン発売",
    1981: "MTV放送開始",
    1985: "レンタルビデオ普及",
    1986: "チェルノブイリ原発事故",
    1989: "ベルリンの壁崩壊",
    1991: "『ターミネーター2』公開<br>デジタル技術の躍進",
    1993: "『ジュラシック・パーク』公開<br>CGIの衝撃",
    1995: "インターネット普及開始",
    1999: "『マトリックス』公開<br>映像表現の革命",
    2001: "9.11同時多発テロ",
    2005: "YouTubeスタート",
    2007: "iPhone発売<br>Netflix配信開始",
    2008: "MCUスタート",
    2009: "『アバター』公開<br>3D映画の再定義",
    2013: "Netflix自社制作開始",
    2017: "トランプ政権発足<br>#MeToo運動",
    2020: "COVID-19パンデミック",
    2022: "生成AIの爆発的普及",
    2023: "ハリウッド大規模スト",
    2025: "第二次トランプ政権発足",
...
function updateHeaderLabels(d1Id, d2Id) {
    ...
    if (labels.length > 1) {
        if (d2Info) {
            ...
            labels[1].style.display = 'block';
            labels[1].innerHTML = `<div class="label-surname contemporary-label-ja">同時代の作品</div><div class="label-ja contemporary-label-en">CONTEMPORARY WORKS</div>`;
        }
    }
}
